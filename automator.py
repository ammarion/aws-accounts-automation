...
"""python3 create_account.py --account_name createonaws@gmail.com --account_email createonaws@@gmail.com"""
...
def main(arguments):
    ...
    #
    #
    # def assume_role_iam_nord():
    #
    #     """
    #         Assume admin role within the nord-IAM account and return credentials
    #     """
    #     s = boto3.Session(profile_name='nord')
    #     sts_client = s.client('sts')
    #     role_arn = 'arn:aws:iam::812653090533:role/managed-role/nordAdmin'
    #
    #     # Call the assume_role method of the STSConnection object and pass the role
    #     # ARN and a role session name.
    #
    ...
    #             assumedroleobject = sts_client.assume_role(
    #                 RoleArn=role_arn,
    #                 RoleSessionName="IAM-nordAccountRole"
    #             )
    #         except botocore.exceptions.ClientError as e:
    #             assuming_role = True
    #             print(e)
    ...
    #     return assumedroleobject['Credentials']
    #
    # # Create groups in iam-nord account
    #
    ...
    # enable_enterpris()
    # credential = assume_role_iam_nord()
    # groups_template = get_groups_template('groups.yml')
    # deploy_groups(credential, template=groups_template, stack_name='nord-iam-groups-' + accountid,
